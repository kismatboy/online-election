...
function send_mail($sendto,$replyto,$name,$subject,$message){
	require 'PHPMailerAutoload.php';
				//$sendto='sajilochat@gmail.com';
	//$name='Homestay Nepal';
	// $replyto='noreply@homestaynepal.com';
				//$subject ='sunil sapkota test mail';
	$body ='<div style="border:2px solid red; height:25px;"><center><b> Online Voating system  message form client </b></center></div><br/><br/>';
	$msg = '<p>'.$message.'</p>';
